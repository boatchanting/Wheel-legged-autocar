...
// ----------------------------------------------------------------------------
#define SPD_KP      0.05f   // [响应力度] 值越大，车对速度误差越敏感，加速越猛，但容易超调晃动
#define SPD_KI      0.002f  // [消除静差] 值越大，车越能克服阻力达到目标速度，但回正越慢
#define SPD_KD      0.0f    // [抑制震荡] 速度环一般不加D，因为编码器噪声大，且不需要极快响应

#define SPD_MAX_I   2000.0f // [积分防饱和] 限制积分项的最大贡献
#define SPD_MAX_O   8.0f    // [安全角度] 速度环输出的是“期望角度”。限制为8度，意味着车最快加速时也不能倾斜超过8度，防止扑街。
...
//    这一环必须响应最快。
// ----------------------------------------------------------------------------
#define GYR_KP      2.5f    // [响应速度] 决定了电机对旋转的抵抗力。
#define GYR_KI      0.0f    // [一般不用] 响应太快，积分来不及反应，反而造成滞后。
#define GYR_KD      0.8f    // [消除抖动] 抑制高频噪声和电机抖动。
