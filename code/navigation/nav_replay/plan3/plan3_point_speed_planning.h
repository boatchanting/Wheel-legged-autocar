...
// =================================================================
// 【科目三(Plan 3) 速度规划专用参数】 (源自Plan2)
// =================================================================
// v^2 = 2ad 中的“指令域减速度”。基于 NAV_SPEED_FAST=-140 调整。
#define NAV_PLAN3_SPEED_DECEL_CMD2_PER_MM       20.0f
// 速度指令上升斜率。
#define NAV_PLAN3_SPEED_ACCEL_STEP              5.0f
// 速度指令正常减速斜率。
#define NAV_PLAN3_SPEED_DECEL_STEP              15.0f
// 跨零或瞬时停车时的最大速度变化量。
#define NAV_PLAN3_SPEED_CROSS_ZERO_STEP         30.0f
