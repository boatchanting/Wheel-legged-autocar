...
#define NAV_POINT_SPECIAL_EXECUTE_RADIUS        250.0f  //华东调试
...
#define NAV_POINT_SPECIAL_BRAKE_MARGIN_MM       00.0f  //华东调试
...
#define NAV_POINT_SPEED_FAST                    (-1300.0f)  //华东调试

// 绕桩点（Flyby）的专属固定目标速度。
// [调参效果]：绕桩时的专属限速。绝对值调大，绕桩更激进，极度考验底盘向心力；绝对值调小，绕桩保守，防滑效果好。
#define NAV_POINT_SPEED_FLYBY                   (-1100.0f)

// 冲线阶段（最后冲刺）的固定全速目标速度。
// [调参效果]：跑完所有路表点后，沿垂线冲向终点线（Y轴）的速度。绝对值调大，冲刺极速更高；绝对值调小，冲刺求稳。
#define NAV_POINT_SPEED_DASH                    (-1500.0f)
