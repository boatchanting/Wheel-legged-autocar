...
#define NAV_POINT_SPECIAL_BRAKE_RADIUS_MIN      3200.0f
#define NAV_POINT_SPECIAL_BRAKE_RADIUS_MAX      3200.0f
...
#define NAV_POINT_SPECIAL_STEP_IN_START_SPEED_MM_S 120.0f
// 执行动作允许的最大实际速度绝对值（mm/s）；进执行圈且 |实际速度| 不超过该值才开转。
#define NAV_POINT_SPECIAL_TRIGGER_SPEED_MM_S    120.0f
