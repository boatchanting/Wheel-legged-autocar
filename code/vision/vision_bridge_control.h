...
#define VISION_BRIDGE_TASK_RUN_MIN_MM                (2000.0f)   /* 上桥后至少行驶 1m，才允许根据视觉出口线脱出 */
...
#define VISION_BRIDGE_TASK_RUN_SPEED_SET             (-220.0f)   /* 桥上正常跑：速度 150 (负数表示前进) */
#define VISION_BRIDGE_TASK_BRIDGE_SPEED_SET          (-220.0f)   /* 看见黑块时：速度 110 */
#define VISION_BRIDGE_TASK_BLIND_SPEED_SET           (-220.0f)    /* 盲跑（看不清线和桥时）：速度 90，慢慢开 */
#define VISION_BRIDGE_TASK_EXIT_SPEED_SET            (-220.0f)    /* 下桥缓冲时：速度 90 */
