...
volatile float g_vision_three_stage_speed_approach = -280.0f; /* 锁定目标靠近时的速度 */
volatile float g_vision_three_stage_speed_jump1    = -280.0f;/* 第一跳寻找速度 */
volatile float g_vision_three_stage_speed_jump2    = -280.0f;/* 第二跳寻找速度 */
volatile float g_vision_three_stage_speed_gap      = -280.0f; /* 短暂丢失过渡阶段速度 */
volatile float g_vision_three_stage_speed_jump3    = -280.0f;/* 第三跳寻找速度 */
volatile float g_vision_three_stage_speed_exit     = -280.0f; /* 最后一跳完成后的驶出减速 */
