...
#define VISION_THREE_STAGE_JUMP3_DELAY_AFTER_JUMP2_TICKS (206U)    /* 180ms，2ms tick */
...
/* 像素阈值默认值（可在线调整） */
#define VISION_THREE_STAGE_JUMP1_BOTTOM_Y_DEFAULT        (34U) //第一级台阶底端小于该值时跳跃，增大阈值，车必须走得更近才跳
#define VISION_THREE_STAGE_JUMP2_TOP_Y_DEFAULT           (37U) //第二级台阶顶端小于该值时跳跃，增大阈值，车必须走得更近才跳 
