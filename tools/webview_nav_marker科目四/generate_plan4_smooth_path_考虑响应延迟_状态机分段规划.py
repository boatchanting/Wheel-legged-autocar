...
示例：
    .venv\\Scripts\\python.exe tools\webview_nav_marker科目四\generate_plan4_smooth_path_考虑响应延迟_状态机分段规划.py
...
SPECIAL_EXIT_DISTANCE_OFFSETS_MM = {30: -150.0, 40: 750.0, 50: 1350.0}
