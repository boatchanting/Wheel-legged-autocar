"""Convert bumpy-road PNG frames to binary PGM for the desktop C detector."""
...
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / "data" / "bumpy_road_c_pgm_frames"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Convert bumpy-road PNG frames to P5 PGM frames.")
