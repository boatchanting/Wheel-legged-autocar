...
//引脚配置
//--------------------------------------------------------------------------------------------------
#include "../code/config/car_select.h"//根据板子配置选择引脚
...
#define GNSS_UART           (UART_2)
#define GNSS_RX             (UART2_TX_P06_1)                                    // GPS RX引脚连接到单片机此
#define GNSS_TX             (UART2_RX_P06_0)                                    // GPS TX串口引脚
...
// *************************** 【小车4】硬件引脚定义开始 ***************************
#define GNSS_UART           (UART_2)
#define GNSS_RX             (UART2_TX_P06_1)
#define GNSS_TX             (UART2_RX_P06_0)
// *************************** 【小车4】硬件引脚定义结束***************************
