/* 移植自 project/tools/.../c_bridge2/bridge_detection.c (2026-08-14),
 * 仅改动本行 include 文件名; 配套头文件 bridge_ref_detection.h 移植自
 * project/code1/vision/bridge_detection.h (车载部署版, 与 .c 差异仅注释)。
 * 远处桥面检测用绝对阈值 fixed_threshold (见 bridge_fusion.h BF_REF_FIXED_THRESHOLD)。 */
#include "bridge_ref_detection.h"
